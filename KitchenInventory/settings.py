"""
Django settings for KitchenInventory project.
...
SECRET_KEY = 'django-insecure-t)4b_eh9*3^sq6#v9(%pa(91-7t#4%or_rs7flbf&0d)j1!5o#'
...
ROOT_URLCONF = 'KitchenInventory.urls'
...
WSGI_APPLICATION = 'KitchenInventory.wsgi.application'
...
if 'PYTHONANYWHERE_DOMAIN' in os.environ:
    # Production MySQL settings for PythonAnywhere
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.mysql',
            'NAME': 'HHillers$kitchen_inventory',
            'USER': 'HHillers',
            'PASSWORD': 'I am a Rocket Man.',
